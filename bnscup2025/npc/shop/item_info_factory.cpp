...
ItemInfo ItemInfoFactory::Get(player::PowerGradeItem item) {
  switch (item) {
    ...
    case player::PowerGradeItem::Nobiru:
      return ItemInfo {
        U"ゴシン術【伸】",
        U"右クリック/RTを押しながら移動しようとすると、自身は移動せずに視点のみ少し移動する。\nエネルギーを消費しないが、回復もしない。レベル上昇で移動距離増加。",
        Array<int> { 5, 5, 8 }
      };
    ...
    case player::PowerGradeItem::Kokoro:
      return ItemInfo {
        U"ゴシン術【心】",
        U"右クリック/RTで使用。エネルギーを消費して視界外の情報が分かる。\n長押しするとエネルギーを消費しながら継続。レベル上昇でエネルギー消費量減少。",
        Array<int> { 10, 8, 10 }
      };
    ...
    case player::PowerGradeItem::Susumu:
      return ItemInfo {
        U"ゴシン術【進】",
        U"右クリック/RTを押している間、音が発生するが通常よりも速く移動できる。\n使用中は常にエネルギーを消費する。レベル上昇で移動速度増加。",
        Array<int> { 8, 8, 10 }
      };
    ...
    case player::PowerGradeItem::Tsutsu:
      return ItemInfo {
        U"ゴシン術【慎】",
        U"右クリック/RTを押している間、移動速度が大幅に低下するが鬼に発見されなくなる。\n既に発見されている場合は効果が無い。レベル上昇でエネルギー消費量減少。",
        Array<int> { 15, 10, 15 }
      };
